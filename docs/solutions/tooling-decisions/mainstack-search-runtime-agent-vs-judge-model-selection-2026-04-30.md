---
title: mainstack-search Runtime Agent Versus Judge Model Selection
date: 2026-04-30
category: tooling-decisions
module: mainstack-search agent fallback benchmarking
...
# mainstack-search Runtime Agent Versus Judge Model Selection

## Context

mainstack-search uses a configured OpenAI-compatible model endpoint to answer
...
- **Runtime fallback model:** used by mainstack-search while serving fallback
...
```sh
MAINSTACK_SEARCH_JUDGE_MODEL=<pro-or-frontier-model>
MAINSTACK_SEARCH_RUNTIME_MODEL=deepseek/deepseek-v4-flash
```

## Related

- [mainstack-search Agent Write Fallback And Durable Replay Hardening](/home/kiyu/Development/IBM/mainstack-search/docs/solutions/security-issues/mainstack-search-agent-write-fallback-durable-replay-hardening-2026-04-30.md)
- [docs/agent-fallback-benchmarks.md](/home/kiyu/Development/IBM/mainstack-search/docs/agent-fallback-benchmarks.md)
- [docs/agent-fallback.md](/home/kiyu/Development/IBM/mainstack-search/docs/agent-fallback.md)
